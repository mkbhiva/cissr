<div class="item teaser-page-list">
    <div class="container_16">
        <aside class="grid_10">
            <h1 class="page-title">कार्यकरणी सूचनाएं</h1>
        </aside>
        <div class="grid_6">
            <div id="rootline">
                <a href="#">Home Page</a> <i class="fa fa-angle-right"></i> <span class="current">कार्यकरणी सूचनाएं</span>
            </div>
        </div>
        <div class="clear"></div>
    </div>
                ...
                <div class="short-content">
                    ...
                    ?>
                        ...
                        <div class="entry-meta">
                            ...
                            </a> <a class="buttons fright" href="<?= site_url('hostelstat/meetdetails/' . $row->notice_url) ?>" title="read more">
                                पूरा पढ़ें
                            </a>
                        </div>
                    <?php } ?>
