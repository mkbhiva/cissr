...
<?php
		...
		$posted_on = $this->timedate->get_nice_date($team_name, 'cool2');
			...
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="single-post">
						...
						</div><!-- Team Member title end -->

						<div class="post-content-area">
							<div class="post-media post-featured-image">
								<img src="<?= base_url() ?>assets/images/blog/main/<?= $team_img ?>" class="img-fluid" alt="<?= $team_name ?>">
							</div>
							...
							<div class="share-items clearfix">
   							<ul class="post-social-icons unstyled">
   								...
   								<li class="twitter">
   									<a href="https://twitter.com/share?url=<?= site_url($post_segments.$post_url) ?>&amp;text=<?php echo $team_name ;?>&amp;hashtags=policemedia, PoliceMediaNEWS" target="_blank">
