				...
				<div class="col-lg-8 col-md-12">
					...
					<div class="single-post">
						...
						<div class="post-content-area">
							<div class="post-media post-featured-image">
								<img src="<?= base_url() ?>assets/images/blog/lifestyle/health5.jpg" class="img-fluid" alt="<?= $team_name ?>">
							</div>
					...
					<div class="comments-form">
						...
						<form role="form">
							...
							<div class="clearfix">
								<button class="comments-btn btn btn-primary" type="submit">Team Member Comment</button> 
							</div>
						</form><!-- Form end -->
