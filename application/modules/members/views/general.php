<div class="item teaser-page-list">
    <div class="container_16">
        <aside class="grid_10">
            <h1 class="page-title">समिति सदस्य</h1>
        </aside>
        <div class="grid_6">
            <div id="rootline">
                <a href="#">Home Page</a> <i class="icon-angle-right"></i> <span class="current">समिति सदस्य</span>
            </div>
        </div>
        <div class="clear"></div>
    </div>
...
<div id="main" class="site-main container_16">
    <div class="inner">
        <div id="primary" class="grid_11 suffix_1">
            <h2>समिति सदस्यों की सूची</h2><br>
            <!-- First article -->
            <article class="list">
                <table class="tblclass">
                    <thead>
                        <tr>
                            <th height="20">सदस्यता संख्या</th>
                    ...
                    <tbody>
                        ...
                        foreach ($query->result() as $row) {
                            ...
                            $join_end = $this->timedate->get_nice_date($row->member_valid, 'mini');
                        ?>
                            <tr>
