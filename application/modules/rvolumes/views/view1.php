<section class="page-header page-header-modern bg-color-secondary custom-section-padding-3 page-header-lg mb-0">
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center text-center">
								<h1 class="text-9 text-color-light custom-secondary-font font-weight-bold mb-1">Volume</h1>
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section section-no-border bg-color-light m-0">
					<div class="container">
						...
						$year = $this->timedate->get_nice_date($volumeDate,'onlyyear');
						?>
						<div class="row">
							<div class="col">
								<article class="custom-research-event bg-color-light">
									...
									<div class="research-event-content custom-margin-1 mb-4">
                                        ...
                                        <hr />
                                        <br />
                                        <h3 class="font-weight-bold text-color-dark mb-3"><?= $volumeNo ?></h3>
                                        <span class="custom-event-infos">
											<ul class="mb-3">
												<li class="text-uppercase">
													<i class="far fa-user"></i>
