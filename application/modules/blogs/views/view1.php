<section class="page-header page-header-modern bg-color-secondary custom-section-padding-3 page-header-lg mb-0">
				...
				<section class="section section-no-border bg-color-light m-0">
					<div class="container">
						<div class="row custom-negative-margin-2 mb-4">
							<div class="col">
								<div class="custom-event-top-image">
									...
									<img src="<?= base_url() ?>assets/images/blog/main/<?= $blog_img ?>" alt class="img-fluid custom-border-1 custom-box-shadow" />
								</div>
							</div>
						...
						$year = $this->timedate->get_nice_date($blog_date,'onlyyear');
						?>
						<div class="row">
							<div class="col">
								<article class="custom-blog-event bg-color-light">
									...
									<div class="blog-event-content custom-margin-1 mb-4">
										<h2 class="font-weight-bold text-color-dark mb-0"><?= $blog_title_en ?></h2>
                                        ...
                                        <hr />
                                        <br />
                                        <h3 class="font-weight-bold text-color-dark mb-3"><?= $blog_title ?></h3>
                                        <span class="custom-event-infos">
											<ul class="mb-3">
												<li class="text-uppercase">
													<i class="far fa-user"></i>
