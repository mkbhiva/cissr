					...
					<div class="single-post">
						...
						<div class="post-content-area">
							<div class="post-media post-featured-image">
								<img src="<?= base_url() ?>assets/images/blog/main/<?= $author_img ?>" class="img-fluid" alt="<?= $author_name ?>">
							</div>
							...
							<div class="share-items clearfix">
   							<ul class="post-social-icons unstyled">
   								...
   								<li class="twitter">
   									<a href="https://twitter.com/share?url=<?= site_url($post_segments.$post_url) ?>&amp;text=<?php echo $author_name ;?>&amp;hashtags=policemedia, PoliceMediaNEWS" target="_blank">
