            ...
            <form class="form-horizontal" action="<?php echo $form_location ;?>" method="post" enctype="multipart/form-data">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="author_name" class="span6 typeahead" value="<?= $author_name ?>" id="typeahead">
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        $additional_dd_code = 'id="selectError"';
                            ...
                            echo form_dropdown('auth_type', $options, $auth_type, $additional_dd_code);
                    ...
                    <div class="control-group hidden-phonee">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" name="author_desc" id="textarea2" rows="3"><?= $author_desc ?></textarea>
                        </div>
                    </div>
...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
               <img src="<?= base_url() ?>assets/images/authors/main/<?= $author_img ?>" />
        </div>
    </div><!--/span-->
</div>
<?php } ?>