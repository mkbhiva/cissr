...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <p>
            <?php 
			$edit_post_url = base_url().'galleryphotos/addphoto/'.$update_id;
			?>
            <a href="<?= $edit_post_url ?>"><button type="button" class="btn btn-primary">Return to Add More Photos</button></a>
            </p>
