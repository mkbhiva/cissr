...
<?php
		...
		$posted_on = $this->timedate->get_nice_date($post_date, 'cool2');
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="single-post">
						...
						<div class="post-content-area">
							<div class="post-media post-featured-image">
								<img src="<?= base_url() ?>assets/images/blog/main/<?= $post_img ?>" class="img-fluid" alt="<?= $post_title ?>">
							</div>
							...
							<div class="share-items clearfix">
   							<ul class="post-social-icons unstyled">
   								...
   								<li class="twitter">
   									<a href="https://twitter.com/share?url=<?= site_url($post_segments.$post_url) ?>&amp;text=<?php echo $post_title ;?>&amp;hashtags=policemedia, PoliceMediaNEWS" target="_blank">
					...
					$query_author = $this->authors->_get_single_author($post_author);
