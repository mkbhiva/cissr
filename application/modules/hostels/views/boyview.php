<div class="item teaser-page-list">
    <div class="container_16">
        <aside class="grid_10">
            <h1 class="page-title">बालक छात्रावास</h1>
        </aside>
        <div class="grid_6">
            <div id="rootline">
                <a href="#">Home Page</a> <i class="fa fa-angle-right"></i> <span class="current">बालक छात्रावास</span>
            </div>
        </div>
        <div class="clear"></div>
    </div>
            ...
            <article class="list">
                ...
                <div class="short-content">
                    <div class="long-description">
                        ...
                        <hr>
                        <br><br>
                        <h2>छात्रों की सूची</h2>
                        <table class="tblclass">
                            <?php
                            $totst = $query->num_rows();
                            ?>
                            <p align="right">
                            <h6>कुल छात्र : <?= $totst ?></h6>
                            </p>
                            <thead>
                                <tr>
                                    <th>#</th>
