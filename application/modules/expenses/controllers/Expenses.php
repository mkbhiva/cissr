...
class Expenses extends MX_Controller
{
    ...
    {
        $query = $this->mdl_expenses->_get_list($limit, $offset);
        return $query;
    }
    ...
    function _get_testimonialsLink()
    {
        ...
        $query = $this->mdl_expenses->_get_testimonialsLink();
    ...
    {
        $query = $this->mdl_expenses->get($order_by);
        return $query;
    }

    function get_with_limit($limit, $offset, $order_by)
    {
        $query = $this->mdl_expenses->get_with_limit($limit, $offset, $order_by);
        return $query;
    }

    function get_where($id)
    {
        $query = $this->mdl_expenses->get_where($id);
        return $query;
    }

    function get_where_custom($col, $value)
    {
        $query = $this->mdl_expenses->get_where_custom($col, $value);
        return $query;
    }

    function _insert($data)
    {
        $this->mdl_expenses->_insert($data);
    }

    function _update($id, $data)
    {
        $this->mdl_expenses->_update($id, $data);
    }

    function _delete($id)
    {
        $this->mdl_expenses->_delete($id);
    }

    function count_where($column, $value)
    {
        $count = $this->mdl_expenses->count_where($column, $value);
        return $count;
    }

    function get_max()
    {
        $max_id = $this->mdl_expenses->get_max();
        return $max_id;
    }

    function _custom_query($mysql_query)
    {
        $query = $this->mdl_expenses->_custom_query($mysql_query);
        return $query;
    }
}
