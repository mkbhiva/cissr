...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <p>
            <?php 
			$edit_interview_url = base_url().'interviews/create/'.$update_id;
			?>
            <a href="<?= $edit_interview_url ?>"><button type="button" class="btn btn-primary">Return to Main Blog Details page</button></a>
            </p>
