			...
			<div class="row">
				<div class="col-lg-8 col-md-12">
					...
					<div class="block category-listing category-style2">
						<h3 class="block-title"><span>Papers</span></h3>
						...
						<div class="post-block-style post-list clearfix">
							...
							$pdf_page = base_url().'assets/pdf/papers/'.$row->fileName;
								...
								<div class="col-lg-6 col-md-6">
									...
									<div class="post-thumbd thumb-float-style">
										<a href="<?= $pdf_page ?>" target="_new">
											<img class="img-fluid" src="<?= base_url() ?>assets/pdf/papers/coverpage/coverp1.jpg" alt="" />
										</a>
									</div>
                                    <div>
