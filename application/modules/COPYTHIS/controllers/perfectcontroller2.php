...
class Perfectcontroller extends MX_Controller {
    ...
    function get_max_id() {
        $max_id = $this->mdl_perfectmodel->get_max_id();
        return $max_id;
    }

    function get_max($col) {
        $query = $this->mdl_perfectmodel->get_max($col);
        return $query;
    }

    function get_sum($col) {
        $query = $this->mdl_perfectmodel->get_sum($col);
        return $query;
    }
