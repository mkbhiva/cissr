...
$date_created = $this->timedate->get_nice_date($notifi_date,'good'); 
							...
							<div class="blog-posts single-post">
								...
								<article class="post post-large blog-single-post">
									...
									<div class="post-content">
                                        ...
                                        <?php if(!$notifi_file=='') { ?>
										<p><a target="_blank" href="<?= base_url() ?>assets/pdf/notifications/<?= $notifi_file ?>"><img src="<?= base_url() ?>assets/images/dowonloadpdf1.png" width="150" /></a></p>
										<?php } ?>	
									</div>
								</article>
