                    ...
                    <span class="thumb-info thumb-info-side-image thumb-info-no-zoom border mt-2">
                        <span class="thumb-info-caption">
                            <span class="thumb-info-caption-text py-0 px-4">
                                <h3 class="mb-1 mt-2"><a title="" class="text-dark" href="<?= site_url('notifications/view/'.$row->notifi_url) ?>"><?= $row->notifi_title ?></a><?php if($new=='New'){ ?><img src="<?= base_url() ?>assets/images/new.gif" class="img-fluid" alt="" style="width: 80px;"><?php } ?></h3>
