...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <p>
            <?php 
			$edit_research_url = base_url().'notifications/create/'.$update_id;
			?>
            <a href="<?= $edit_research_url ?>"><button type="button" class="btn btn-primary">Return to Main Notification Details page</button></a>
            </p>
