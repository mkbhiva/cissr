			...
			?>
				<div class="col-md-4 col-sm-4 col-xs-12">
					<div class="gallerypic">
					 <img src="<?= base_url() ?>assets/images/tempimages/<?= $row->temp_img ?>" class="img-responsive" alt="<?= $row->gallery_title ?>" />
					</div>
				...
				<div class="col-md-7 col-sm-7 col-xs-12 col-md-offset-1">
					...
					<!-- gallery popup -->
									<div class="gallery">
										<a href="<?= site_url('tempphotos/album/'.$row->id) ?>" class="btn btn-primary btn-lg mr50">View Album</a>
									</div>
								<!-- gallery popup// -->
				 </div>
				 <div class="clearfix"></div>
