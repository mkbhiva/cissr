...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
				...
				echo form_open_multipart('ourevents/upload_video/'.$update_id, $attributes);
				?>
                <fieldset>
			   ...
			   if(isset($flash)){
                ...
                <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="post_video" class="span6 typeahead" value="<?= $post_video ?>" id="typeahead">
                        </div>
                    </div>  
...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
               <iframe width="560" height="315" src="https://www.youtube.com/embed/<?= $post_video ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
    </div><!--/span-->
</div>
<?php } ?>