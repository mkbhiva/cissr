...
class Whatsapp extends MX_Controller {
    ...
    function _get_whatsappLink(){
        ...
        $query = $this->mdl_whatsapp->_get_whatsappLink();
    ...
    function get($order_by) {
        $query = $this->mdl_whatsapp->get($order_by);
        return $query;
    }

    function get_with_limit($limit, $offset, $order_by) {
        $query = $this->mdl_whatsapp->get_with_limit($limit, $offset, $order_by);
        return $query;
    }

    function get_where($id) {
        $query = $this->mdl_whatsapp->get_where($id);
        return $query;
    }

    function get_where_custom($col, $value) {
        $query = $this->mdl_whatsapp->get_where_custom($col, $value);
        return $query;
    }

    function _insert($data) {
        $this->mdl_whatsapp->_insert($data);
    }

    function _update($id, $data) {
        $this->mdl_whatsapp->_update($id, $data);
    }

    function _delete($id) {
        $this->mdl_whatsapp->_delete($id);
    }

    function count_where($column, $value) {
        $count = $this->mdl_whatsapp->count_where($column, $value);
        return $count;
    }

    function get_max() {
        $max_id = $this->mdl_whatsapp->get_max();
        return $max_id;
    }

    function _custom_query($mysql_query) {
        $query = $this->mdl_whatsapp->_custom_query($mysql_query);
        return $query;
    }
