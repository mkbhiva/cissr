...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <?php if($gallery_img=="") { ?>
               <a href="<?= base_url() ?>webgallery/upload_image/<?= $update_id ?>"><button type="button" class="btn btn-primary">Upload Profile Image</button></a>
               <?php } else { ?>
               <a href="<?= base_url() ?>webgallery/delete_image/<?= $update_id ?>"><button type="button" class="btn btn-danger">Delete Profile Image</button></a>
               <?php } ?>
               ...
               <a target="_new" href="<?= base_url() ?>webgallery/album/<?= $update_id ?>"><button type="button" class="btn btn-default">View Item on Website</button></a>
...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
        <?php
        $form_location = base_url()."webgallery/create/".$update_id;
            ...
            <form class="form-horizontal" action="<?php echo $form_location ;?>" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="<?= base_url() ?>webgallery/manage" class="btn">Cancel</a>
                    </div>
                </fieldset>
            </form>   
...
<div class="row-fluid sortablee">
    <div class="box span12">
        ...
        <div class="box-content">
               <img src="<?= base_url() ?>assets/images/gallery/gallery_title/<?= $gallery_img ?>" width="200"/>
        </div>
    </div><!--/span-->
</div>
<?php } ?>